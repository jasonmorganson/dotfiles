...
# Generated bootstrap base:
#   mise generate bootstrap --version 2026.7.5 --write install.sh
#
# Keep repository-specific setup in __dotfiles_handoff below. Regenerate this
# file with the command above, then restore that function and its invocation.
