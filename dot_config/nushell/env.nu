...
let-env PATH = ($env.PATH | split row (char esep) | prepend '/usr/local/bin' | prepend '/home/linuxbrew/.linuxbrew/bin' | prepend '/opt/homebrew/bin' | prepend $"($env.HOME)/.tea/tea.xyz/v*/bin" | prepend $"($env.HOME)/.local/share/rtx/bin")
